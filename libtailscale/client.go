...
// File added by cylonix to expose a thin wrapper around the LocalAPI
// for use from the JNI SendCommand entry point. Originally converted
// from tailscale-android/android/src/main/java/com/tailscale/ipn/ui/localapi/Client.kt
// __END_CYLONIX_ADD__
