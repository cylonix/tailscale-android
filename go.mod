...
go 1.26.1 // __CYLONIX_MOD__ match cylonix tailscale fork toolchain rev

require (
	github.com/tailscale/wireguard-go v0.0.0-20260304043104-4184faf59e56
	golang.org/x/mobile v0.0.0-20240806205939-81131f6468ab
	tailscale.com v1.95.0-pre.0.20260305133141-d82e478dbcae
)

// __BEGIN_CYLONIX_ADD__
// Pin tailscale.com to the cylonix fork. This adds the cylonix-only LocalAPI
// endpoints (l2relay, dns-query, peer-message) and engine helpers used from
// libtailscale/.
//
// NOTE: the published v1.96.4-cylonix.0 tag has a known android build break
// in feature/taildrop/retrieve.go (the cylonix-added GetFilePath references
// fsFileOps unconditionally, but fsFileOps is !android only). Until a fixed
// tag is published (v1.96.4-cylonix.1), point this replace at the local
// cylonix tailscale checkout which carries the build-tag fix as
