...
require (
	...
	tailscale.com v1.79.0-pre.0.20250129204401-8bd04bdd3a6c
)
...
require (
	...
	github.com/cylonix/cylonix-web-client-prebuilt v0.1.3 // indirect
...
replace tailscale.com => ../tailscale // __CYLONIX_MOD__
